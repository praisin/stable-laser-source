function [plotData]=plotADEV_multiple(data,avar, name, store,color, featureScaling)
    ...
    figure(1);
    hold on;
    plotData = [tau1h; avar.sig2/AV; avar.sig2err/AV];
    ...
    ylabel('relative ADEV \sigma_y ','FontSize',14,'FontName','Arial');
